...
**Title:** Predicting plasmid destinations: Harnessing k-mer composition for conjugative transfer inference
...
**Tokuda et al. “***Predicting plasmid destinations: Harnessing k-mer composition for conjugative transfer inference***”**
...
It is used to assess how well the models generalize to plasmids or recipients that were not included in the training data (Supplementary text section 2).
...
### Prediction
Predictions against the 127 recipient candidates can be performed using **04_predict_folder_cano.py** by providing the target plasmid sequences as input.
...
### **DNABERT**
The features for DNABERT-derived embedding model were generated by using **host_dnabert.py** and **plasmid_dnabert.py** from plasmid and chromosomeFASTA files.
